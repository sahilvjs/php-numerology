...
class Numerology {
	...
	function get_sum_of_name() {
		
		$name_array = str_split(strtolower($this->user_details['name']));
		$sum_of_name = 0;
	...
	function digit_sum_reduce($number, $type = 'none') 
	{ 
	    $sum = 0; 
	...
	function set_user_details($name, $dob, $gender) {
